...
exports.login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, password, userDB, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
...
// import UserModel from "./loginModel"; // Assuming you have a User model defined
// import { Types } from "mongoose";
// export const login = async (req: Request, res: Response) => {
//   const { email, password } = req.body;
//   try {
//     const user: any = await UserModel.findOne({ email }); // Use 'any' type assertion
//     if (!user) {
...
//   }
// };
// function generateJWT(_id: Types.ObjectId) {
